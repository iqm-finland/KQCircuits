...
class XMonsDirectCoupling(Chip):
    ...
    def produce_qubits(self):
        ...
        * insert_cell
        ...
        self.insert_cell(
            finnmon_2, trans=pya.DTrans(5e3, qubit_y), inst_name="QB2", label_trans=pya.DTrans.R90, rec_levels=None
        )
        self.insert_cell(
            finnmon_3,
            trans=pya.DTrans(5e3 + qubit_step + self.qubit_spacing, qubit_y),
    ...
    def build(self):
        ...
        self.produce_readout_resonator(
            self.refpoints["QB1_port_cplr1"], height_rr_feedline, 2421.5 + 2447.1, name="1", c_kappa_l_fingers=60.8
        )
        self.produce_readout_resonator(
            self.refpoints["QB2_port_cplr1"], height_rr_feedline, 2436 + 2246.3, name="2", c_kappa_l_fingers=61.55
        )
        self.produce_readout_resonator(
            self.refpoints["QB3_port_cplr1"], height_rr_feedline, 2438.5 + 2248.2, name="3", c_kappa_l_fingers=58.1
        )
