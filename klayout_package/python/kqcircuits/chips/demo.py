...
class Demo(Chip):
    ...
    def produce_fluxline(self, qubit_nr):
        self.insert_cell(
            ...
            nodes=[
                ...
                Node(
                    self.refpoints[f"QB{qubit_nr}_port_flux_corner"], n_bridges=4
                ),
    ...
    def produce_readout_structure(self, qubit_nr, mirrored, cap_finger_nr):
        ...
        self.insert_cell(
            ...
            align="port_bottom",
            **t_cross_parameters(
                a=self.a, b=self.b, a2=self.a, b2=self.b, length_extra_side=30
            ),
        )
    ...
    def produce_probeline(self, probeline_name, qubit_a_nr, qubit_b_nr, mirrored, cap_finger_nr):
        ...
        cap_trans = pya.DTrans(
            cap_rot,
            False,
            self.refpoints[f"PL{qubit_a_nr}_port_left"] + cap_pos_shift,
        )
