...
def test_encodes_standard_python_types():
    ...
    assert json.dumps(list_var, cls=GeometryJsonEncoder) == "[42, 1.23, \"test_string\", true, false, null]",\
    ...
    assert json.dumps(tuple_var, cls=GeometryJsonEncoder) == "[42, 1.23, \"test_string\", true, false, null]",\
...
def test_encodes_dpoint():
    assert json.dumps(pya.DPoint(-1000, 5.67), cls=GeometryJsonEncoder) ==\
        '{"_pya_type": "DPoint", "x": -1000.0, "y": 5.67}', "DPoint not encoded correctly"
...
def test_encodes_dvector():
    assert json.dumps(pya.DVector(-1000, 5.67), cls=GeometryJsonEncoder) ==\
        '{"_pya_type": "DVector", "x": -1000.0, "y": 5.67}', "DVector not encoded correctly"
...
def test_encodes_layerinfo():
    assert json.dumps(pya.LayerInfo(1001, 2), cls=GeometryJsonEncoder) ==\
        '{"_pya_type": "LayerInfo", "layer": 1001, "datatype": 2}', "LayerInfo not encoded correctly"
...
def test_encodes_dpath():
    ...
    assert json.dumps(dpath_var, cls=GeometryJsonEncoder) == ('{'
        ...
        '], "width": 13.0}'), "DPath not encoded correctly"
...
def test_encodes_dpolygon():
    encoded_dpolygon = encode_python_obj_as_dict(pya.DPolygon([
        pya.DPoint(1.2, 3), pya.DPoint(-3.4, 5), pya.DPoint(6, -7.8), pya.DPoint(-1000, 1000)
    ]))
...
def test_encode_composite_dict():
    ...
    assert set(encoded_dict["test_layer"].keys()) == set(["_pya_type", "layer", "datatype"]),\
        "Dict with pya shapes not encoded correctly"
    ...
    assert set(encoded_dict["test_vectors"][0].keys()) == set(["_pya_type", "x", "y"]),\
        "Dict with pya shapes not encoded correctly"
    ...
    assert set(encoded_dict["test_vectors"][1].keys()) == set(["_pya_type", "x", "y"]),\
        "Dict with pya shapes not encoded correctly"
    ...
    assert set(encoded_dict["test_vectors"][3].keys()) == set(["_pya_type", "x", "y"]),\
        "Dict with pya shapes not encoded correctly"
    ...
    assert set(encoded_dict["test_point_sets"].keys()) == set(["path", "polygon", "just_points"]),\
        "Dict with pya shapes not encoded correctly"

    assert set(encoded_dict["test_point_sets"]["path"].keys()) == set(["_pya_type", "points", "width"]),\
        "Dict with pya shapes not encoded correctly"
    ...
    _check_dpoint_dict(encoded_dict["test_point_sets"]["path"]["points"][0], 0, -1,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["test_point_sets"]["path"]["points"][1], 1, 0,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["test_point_sets"]["path"]["points"][2], 0.33, 0.66,
        "Dict with pya shapes not encoded correctly")

    assert set(encoded_dict["test_point_sets"]["polygon"].keys()) == set(["_pya_type", "hull", "holes"]),\
        "Dict with pya shapes not encoded correctly"
    assert encoded_dict["test_point_sets"]["polygon"]["_pya_type"] == "DPolygon",\
        "Dict with pya shapes not encoded correctly"
    ...
    assert len(encoded_dict["test_point_sets"]["polygon"]["holes"][0]) == 3, "Dict with pya shapes not encoded correctly"
    assert len(encoded_dict["test_point_sets"]["polygon"]["holes"][1]) == 3, "Dict with pya shapes not encoded correctly"
    ...
    _check_dpoint_dict(encoded_dict["test_point_sets"]["just_points"][0], -2, 2,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["test_point_sets"]["just_points"][1], 1, -1,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["test_point_sets"]["just_points"][2], 1.33, 2.66,
        "Dict with pya shapes not encoded correctly")
    ...
    assert set(encoded_dict["deep_hierarchy"].keys()) == set(["very_deep_hierarchy", "box"]),\
        "Dict with pya shapes not encoded correctly"
    assert "_pya_type" not in encoded_dict["deep_hierarchy"]["very_deep_hierarchy"],\
        "Dict with pya shapes not encoded correctly"
    assert set(encoded_dict["deep_hierarchy"]["very_deep_hierarchy"].keys()) == set(["edge"]),\
        "Dict with pya shapes not encoded correctly"

    assert set(encoded_dict["deep_hierarchy"]["very_deep_hierarchy"]["edge"].keys()) == set(["_pya_type", "p1", "p2"]),\
        "Dict with pya shapes not encoded correctly"
    assert encoded_dict["deep_hierarchy"]["very_deep_hierarchy"]["edge"]["_pya_type"] == "DEdge",\
        "Dict with pya shapes not encoded correctly"
    _check_dpoint_dict(encoded_dict["deep_hierarchy"]["very_deep_hierarchy"]["edge"]["p1"], -123.45, 54.321,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["deep_hierarchy"]["very_deep_hierarchy"]["edge"]["p2"], 13.421, 45.231,
        "Dict with pya shapes not encoded correctly")

    assert set(encoded_dict["deep_hierarchy"]["box"].keys()) == set(["_pya_type", "p1", "p2"]),\
        "Dict with pya shapes not encoded correctly"
    assert encoded_dict["deep_hierarchy"]["box"]["_pya_type"] == "DBox", "Dict with pya shapes not encoded correctly"
    _check_dpoint_dict(encoded_dict["deep_hierarchy"]["box"]["p1"], -98.765, -89.763,
        "Dict with pya shapes not encoded correctly")
    _check_dpoint_dict(encoded_dict["deep_hierarchy"]["box"]["p2"], 67.876, 789.87,
        "Dict with pya shapes not encoded correctly")
